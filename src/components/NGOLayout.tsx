...
import { Heart, Map, MessageSquare, ClipboardCheck, User, LogOut, Home } from 'lucide-react';
...
const NGOLayout: React.FC<NGOLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Heatmap', href: '/ngo/dashboard', icon: Map },
    { name: 'Inform', href: '/ngo/inform', icon: MessageSquare },
    { name: 'Applications', href: '/ngo/application', icon: ClipboardCheck },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      <div className="w-64 bg-white shadow-sm flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-2">NGO Dashboard</p>
        </div>
